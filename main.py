...
print 'a:' + get(model[u_a_1], model[v_a_1], model[u_a_2], model[v_a_2])
print 'b:' + get(model[u_b_1], model[v_b_1], model[u_b_2], model[v_b_2])
print 'c:' + get(model[u_c_1], model[v_c_1], model[u_c_2], model[v_c_2])
print 'd:' + get(model[u_d_1], model[v_d_1], model[u_d_2], model[v_d_2])
print 'e:' + get(model[u_e_1], model[v_e_1], model[u_e_2], model[v_e_2])